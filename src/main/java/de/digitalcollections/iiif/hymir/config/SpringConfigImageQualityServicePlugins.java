...
@Profile("plugins")
@ComponentScan(
        basePackages = {"${custom.plugins.packages:de.digitalcollections.iiif.hymir.image}"}
)
public class SpringConfigImageQualityServicePlugins {
    protected static final Logger LOGGER = LoggerFactory.getLogger(SpringConfigImageQualityServicePlugins.class);
